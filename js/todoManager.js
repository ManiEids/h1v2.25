...
export async function initialize() {
  ...
  try {
    ...
    // Sync with source data in case there are updates
    const sourceData = await fetch('data/data.json').then((res) => res.json());
    data = await syncWithLocalStorage(sourceData);
