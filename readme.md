...
Verkefnalisti (Todo App) sem geymir stöðu í vafra notanda. Verkefnið var unnið sem Hópverkefni 2 í Vefforritun 1, 2021.

## Keyrsla verkefnis

Eftirfarandi skipanir eru í boði:

- `npm run dev` - Keyrir verkefnið með live-server
- `npm start` - Sama og `npm run dev`
- `npm run lint` - Keyrir ESLint og Stylelint
- `npm run sass` - Fylgist með breytingum á Sass skrám og þýðir í CSS

## Uppsetning verkefnis

### Möppur og skrár

- `/data` - Inniheldur gögn fyrir verkefnið
  - `data.json` - Upphafsgögn sem notuð eru til að byrja með
- `/js` - JavaScript skrár
  - `main.js` - Aðalskrá sem sér um viðmót og virkni
  - `todoManager.js` - Sér um meðhöndlun verkefna
  - `localStorageManager.js` - Sér um samskipti við localStorage
- `/sass` - Sass skrár fyrir útlit
  - `main.scss` - Aðal Sass skrá
- `/css` - Inniheldur þýddar CSS skrár (ekki í Git)

### CSS/Sass skipulag

Sass skrár eru skipulagðar með eftirfarandi hætti:
- Breytur eru skilgreindar efst í skrá (litir, leturgerðir, o.s.frv.)
- Grunnstílar eru skilgreindir næst (reset, body, o.s.frv.)
- Síðan koma sértækari stílar fyrir hvern hluta verkefnisins
- Media queries eru skilgreindar innan hvers hluta eftir þörfum

## Hópmeðlimir

- [Nafn Nemanda 1] - [HÍ notendanafn] - [GitHub notendanafn]
- [Nafn Nemanda 2] - [HÍ notendanafn] - [GitHub notendanafn]
- [Nafn Nemanda 3] - [HÍ notendanafn] - [GitHub notendanafn]
- [Nafn Nemanda 4] - [HÍ notendanafn] - [GitHub notendanafn]

## Netlify hlekkur

Verkefnið er hýst á Netlify: [Setja inn hlekk hér]
